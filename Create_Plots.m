...
% excel_file = 'Data_11-11-2020.csv';
excel_file = 'Data_05-15-2021_sized.csv';
...
% main_folder = 'D:\Google Drive\Muscle Modeling\Min_jerk_files';
main_folder = 'd:\Users\Gary\Google Drive\Muscle modeling\Min_jerk_files';
count = 1;
...
%             fit_method = fit_methods{p};
            ...
            cd([main_folder filesep '2021 may Data']);
            load(sprintf('aa_%scost_04-29-2021_sized_220normstress.mat',minparams{k1}));
%             cd([main_folder filesep '2020 Data']);
%             load(sprintf('aa_%scost_11-11-2020_nobuff.mat',minparams{k1}));
%             load(sprintf('aa_%scost_6-28-2020.mat',minparams{k1}));
