...
excel_file = 'Data_11-11-2020_mj.csv';
% excel_file = 'Data_6-28-2020.csv';
% excel_file = 'Data_09-17-2019_rng.csv';
...
%             fit_method = fit_methods{p};
            ...
            load(sprintf('aa_%scost_11-11-2020_mj.mat',minparams{k1}));
%             load(sprintf('aa_%scost_6-28-2020.mat',minparams{k1}));
%             load(sprintf('aa_%scost_09-17-2019_rng.mat',minparams{k1}));
%             c = 4;
%             for t = 1:8
%                 for s = 1:6
