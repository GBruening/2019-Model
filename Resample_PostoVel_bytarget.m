...
% end
fold = pwd;
if ~exist('MT1') && ~exist('MT')
    fprintf('Loading Data\n');
    cd('C:\Users\Gary\Google Drive\Muscle modeling\Metabolics\Data');
...
n_samp = 100;
tr_count2 = 1;
% ResampleDataP = zeros(nc,nsubj,nspeed,ntar,140,100);
% ResampleDataV = zeros(nc,nsubj,nspeed,ntar,140,100);
% ResampleDataT = zeros(nc,nsubj,nspeed,ntar,140,100);
    ...
    for s = 1:7
        for subj=1:nsubj
            ...
            for i=start_trial:popts.totaltrials
                    ...
                    end_time(c,subj,s,tar,tr_count2) = abs(Data_met{c,subj,s}.time(MT{c,subj,s}.idxendpt(i),i))-...
                            Data_met{c,subj,s}.time(MT{c,subj,s}.idxonset(i),i);
